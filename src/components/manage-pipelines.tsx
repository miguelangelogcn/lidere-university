...
export function ManagePipelines() {
  ...
  return (
    <div className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-6 max-h-[80vh] overflow-y-auto">
      <DialogHeader>
        <DialogTitle>Gerenciar Funis de Venda</DialogTitle>
        <DialogDescription>Crie, edite e exclua seus funis de venda.</DialogDescription>
      </DialogHeader>
